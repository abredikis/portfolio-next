...
export default function NavBar({
  ...
  return (
    ...
    >
      <div className='relative mx-auto flex w-full max-w-[90rem] items-center ~gap-6/9'>
        <div
          className={cn(
            'absolute right-0 top-0 z-10 flex w-full flex-grow origin-[90%_15%] scale-0 flex-col items-center justify-end rounded-xl bg-white px-5 py-5 opacity-0 shadow-2xl shadow-primary-950/20 ~gap-6/9 [transition:transform_0.375s,opacity_0.225s] sm:max-w-80 lg:shadow-none xl:static xl:w-auto xl:max-w-full xl:scale-100 xl:flex-row xl:bg-transparent xl:p-0 xl:opacity-100',
            isMenuOpen
